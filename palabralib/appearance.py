...
class AppearanceDialog(gtk.Dialog):
    ...
    def create_content(self):
        ...
        # blocks
        label = create_label(u"Color")
        table.attach(label, 1, 2, 5, 6, gtk.FILL, gtk.FILL)
        label = create_label(u"Margin (%)")
        table.attach(label, 2, 3, 5, 6, gtk.FILL, gtk.FILL)
