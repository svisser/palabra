...
class PrefsTestCase(unittest.TestCase):
    ...
    def testDefaults(self):
        ...
        for key, pref in DEFAULTS.items():
            self.assertEqual(preferences.prefs[key], pref.value)
        self.assertEqual(len(preferences.prefs), len(DEFAULTS))
    ...
    def testBoolPref(self):
        ...
        self._writeRead()
        self.assertEqual(preferences.prefs[constants.PREF_COPY_BEFORE_SAVE], True)

    def testIntPref(self):
        preferences.prefs[constants.PREF_INITIAL_HEIGHT] = 27
        self._writeRead()
        self.assertEqual(preferences.prefs[constants.PREF_INITIAL_HEIGHT], 27)
    ...
    def testColor(self):
        ...
        self._writeRead()
        self.assertEqual(preferences.prefs[constants.COLOR_PRIMARY_SELECTION + "_red"], 1234)
    ...
    def testReadColor(self):
        ...
        self.assertEqual(g, 23456.0)
        self.assertEqual(b, 34567.0)
